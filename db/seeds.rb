...
L’équipe d’Alacaza – Alexis, Michael et Rémy", building_id: Building.where(name: "12 Rue Jean Richepin").last.id, user_id: User.where(first_name: "Alacaza").last.id)
message.save
message = Message.new(body: "Bienvenue dans la communauté Alacaza !. Vous pouvez communiquer à l’ensemble des membres de l’immeuble dans ce fil de messages.
  Si nous avez la moindre question, n'hésitez pas à nous contacter: 07 68 45 33 00.
L’équipe d’Alacaza – Alexis, Michael et Rémy", building_id: Building.where(name: "3 rue Elzevir").last.id, user_id: User.where(first_name: "Alacaza").last.id)
message.save
message = Message.new(body: "Bienvenue dans la communauté Alacaza !. Vous pouvez communiquer à l’ensemble des membres de l’immeuble dans ce fil de messages.
  Si nous avez la moindre question, n'hésitez pas à nous contacter: 07 68 45 33 00.
L’équipe d’Alacaza – Alexis, Michael et Rémy", building_id: Building.where(name: "10 rue des Bateliers").last.id, user_id: User.where(first_name: "Alacaza").last.id)
message.save
