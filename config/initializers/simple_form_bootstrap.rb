...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_input_group, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    ...
    b.wrapper :input_wrapper, tag: 'div' do |ba|
      ba.wrapper :input_group_wrapper, tag: 'div', class: 'input-group' do |append|
  ...
  # Delete class: "form-group" after vertical_radio_and_checkboxes to remove negative margins in admin/venues/show.html
  ...
  config.wrappers :horizontal_input_group, tag: 'div', error_class: 'has-error' do |b|
      ...
      b.wrapper :my_wrapper, tag: 'div', class: "form-inline" do |ba|
  ...
  config.wrappers :horizontal_boolean, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    ...
    b.wrapper :checkbox_wrapper, tag: 'div', class: 'col-sm-offset-3 col-sm-9' do |wr|
